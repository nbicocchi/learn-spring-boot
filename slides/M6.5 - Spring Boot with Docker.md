...
```
[INFO] Building image 'docker.io/library/spring-with-docker-end:0.1.0-SNAPSHOT'
```
...
$ docker images
...
spring-with-docker-end             0.1.0-SNAPSHOT          c54fe8fa3ca3        4 days ago        388MB
...
```
...
9255a745e860   spring-with-docker-end:0.1.0-SNAPSHOT   "/cnb/process/web"   17 seconds ago   Up 17 seconds   0.0.0.0:8080->8080/tcp   spring-with-docker-end
```
...
<build>
    <plugins>
        <plugin>
            ...
            <configuration>
                <image>
                    <name>spring-with-docker-end:${project.version}</name>
                </image>
            </configuration>
            <executions>
                <execution>
    ...
    <build>
        <plugins>
            ...
            <plugin>
                ...
                <configuration>
                    <to>
                        <image>spring-with-docker-end-jib:${project.version}</image>
                    </to>
                </configuration>
            </plugin>
            ...
...
...
spring-with-docker-end             0.1.0-SNAPSHOT          c54fe8fa3ca3    4 days ago     388MB
spring-with-docker-end-jib         0.1.0-SNAPSHOT          af090b82786b   54 years ago    315MB
...
```
