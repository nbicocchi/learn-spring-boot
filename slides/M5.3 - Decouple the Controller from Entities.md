...
The relevant module for this lesson is: [decouple-controller-from-entities-end](../code/learn-spring-m5/decouple-controller-from-entities-end), [decouple-controller-from-entities-mapstruct-end](../code/learn-spring-m5/decouple-controller-from-entities-mapstruct-end)
