...
public class PaginationAndSortingApp implements ApplicationRunner {

    private static final Logger LOG = LoggerFactory.getLogger(PaginationAndSortingApp.class);

    private TaskRepository taskRepository;

    public PaginationAndSortingApp(TaskRepository taskRepository) {
        this.taskRepository = taskRepository;
    }

    public static void main(final String... args) {
        SpringApplication.run(PaginationAndSortingApp.class, args);
    }
